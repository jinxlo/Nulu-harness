 ...
 * canonical source into the route tree of the site.
 */
...
const reference: DocsPage[] = [
  // `docs/nulu-llm-api-wire-extensions.md` is a repository-only provider protocol reference.
  ...
  ...([
    ['docs/cordis-primer.md', 'reference/cordis-primer.md', 'Cordis primer', 1],
 ...
 */
export const collections = ['guide', 'develop', 'reference'] as const satisfies readonly DocsSidebar[]
