...
**Normalize the provider and policy messages at their source.** Rejected because those components own machine-oriented errors used by consumers other than `nulu-tool-fs`; only the tool owns this model-visible wording.
