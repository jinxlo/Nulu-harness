...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`nulu-archive-agent-notes`](../../skills/nulu-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
