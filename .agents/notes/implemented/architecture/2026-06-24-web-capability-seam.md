...
2. Provider packages implement concrete backends and register capabilities with `ctx.web`, for example `@worldapptechnologies/nulu-web-search-exa`, `@worldapptechnologies/nulu-web-search-perplexity`, `@worldapptechnologies/nulu-web-search-gateway`, and `@worldapptechnologies/nulu-web-fetch-http`.
...
@worldapptechnologies/nulu-tool-web  --depends on-->  @worldapptechnologies/nulu-web  <--depends on--  @worldapptechnologies/nulu-web-search-exa
        consumer                                 interface                       implementation
                                                                 <--depends on--  @worldapptechnologies/nulu-web-search-perplexity
                                                                                  implementation
                                                                 <--depends on--  @worldapptechnologies/nulu-web-search-gateway
                                                                                  implementation
...
flowchart LR
  ...
  nulu["@worldapptechnologies/nulu-web-search-gateway"] -->|registerSearchProvider| web
...
- id: web-search-gateway
  name: '@worldapptechnologies/nulu-web-search-gateway'
