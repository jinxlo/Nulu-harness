...
[`@worldapptechnologies/nulu-package-manifest`](../../../../packages/util/package-manifest/README.md) owns `NuluManifest` and its member declarations in one type-only file. The package belongs to the existing utility group and exports no runtime values. The [public package metadata decision](2026-09-10-public-package-manifest.md) owns the public field set and the separation from internal tool metadata.
