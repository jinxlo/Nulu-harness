...
- Human slash-command discovery and rendering are owned by the separate [`nulu-command-goal`](../../../../packages/goal/command-goal/README.md) plugin.
