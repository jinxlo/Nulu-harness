...
- **翻译是 agent 的工作，由人评审。** 常规改动采用由 [docs/i18n/README.md](../../../../docs/i18n/README.zh.md) 规定的直接单遍路径。[扩展翻译 skill（技能）](../../../skills/nulu-translate-docs/SKILL.md)保留委派翻译和其他较重机制，供用户显式调用；两条路径均以文档契约为真源。
