...
- **A thin workflow skill, contracts in docs.** [.agents/skills/nulu-doc](../../../skills/nulu-doc/SKILL.md) carries the placement, audit, budget, and website workflow and defers to the standard as its source of truth, the same split as [nulu-translate-docs](../../../skills/nulu-translate-docs/SKILL.md) over the i18n contract.
