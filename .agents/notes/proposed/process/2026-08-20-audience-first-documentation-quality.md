...
1. Create and validate `nulu-doc`, then rewrite one package README pair as a line-aligned, metadata-bearing prototype without changing runtime claims.
