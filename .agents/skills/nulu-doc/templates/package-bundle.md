...
Use this template for a package whose manifest declares `nulu.bundle.patch` — an installable profile layer: `packages/bundle/*`, `nulu-subagent-codex`, `nulu-subagent-claude-code`. The `bundle/base` README is the worked example.
