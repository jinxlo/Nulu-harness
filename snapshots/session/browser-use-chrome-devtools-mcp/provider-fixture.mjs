...
export async function apply(ctx) {
  ...
  const provider = await import('@worldapptechnologies/nulu-experimental-browser-use-chrome-devtools-mcp')
  ...
  ctx.on('agent/pre-step', async (_payload, next) => {
    if (await readFile(resolve('.nulu/browser-fixture.started'), 'utf8') !== 'chrome-devtools-mcp\n') {
