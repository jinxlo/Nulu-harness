import { Context, Inject, Service, type Plugin } from '@worldapptechnologies/cordis'
import type { Dict } from '@worldapptechnologies/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@worldapptechnologies/cordis-plugin-loader'
import type { Include } from '@worldapptechnologies/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { relative, resolve } from 'node:path'
import { realpath } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@worldapptechnologies/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [nulu-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
