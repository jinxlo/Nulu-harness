import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@worldapptechnologies/cordis-plugin-loader'
 ...
 * (`nulu --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
