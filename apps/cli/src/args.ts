...
/** The resolved `nulu` invocation. Help, version, and errors exit inside {@link parseNuluArgs}. */
export type NuluInvocation = ProfileInvocation | DumpConfigInvocation | PluginInvocation
 ...
 */
function resolveBoot(program: Command, profile: string, options: BootOptions, args: string[]): NuluInvocation {
 ...
 * @returns the resolved invocation.
 */
export function parseNuluArgs(argv: readonly string[], version: string): NuluInvocation {
  let resolved: NuluInvocation | undefined
