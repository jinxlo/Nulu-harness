...
flowchart LR
  ...
  plugin_nulu_base_deepseek_llm_api_extensions["deepseek-llm-api-extensions<br/>@worldapptechnologies/nulu-deepseek-llm-api-extensions"]
  cfg --> plugin_nulu_base_deepseek_llm_api_extensions
  plugin_nulu_base_session["session<br/>@worldapptechnologies/nulu-session"]
  cfg --> plugin_nulu_base_session
  plugin_nulu_base_session_log_deepseek["session-log-deepseek<br/>@worldapptechnologies/nulu-session-log-deepseek"]
  cfg --> plugin_nulu_base_session_log_deepseek
  ...
  plugin_nulu_base_plugin_package_inventory_deepseek["plugin-package-inventory-deepseek<br/>@worldapptechnologies/nulu-plugin-package-inventory-deepseek"]
  cfg --> plugin_nulu_base_plugin_package_inventory_deepseek
  ...
  plugin_nulu_base_nulu_5_ultra["nulu-5-ultra<br/>Nulu 5 Ultra"]
  cfg --> plugin_nulu_base_nulu_5_ultra
  ...
  plugin_nulu_base_workflow_worker_thread["workflow-worker-thread<br/>@worldapptechnologies/nulu-workflow-worker-thread"]
  cfg --> plugin_nulu_base_workflow_worker_thread
  ...
  plugin_nulu_base_web_search_deepseek["web-search-deepseek<br/>@worldapptechnologies/nulu-web-search-deepseek"]
  cfg --> plugin_nulu_base_web_search_deepseek
  ...
  plugin_nulu_base_llm_deepseek["llm-deepseek<br/>@worldapptechnologies/nulu-llm-deepseek"]
  cfg --> plugin_nulu_base_llm_deepseek
```
...
| `workflow-worker-thread` | `@worldapptechnologies/nulu-workflow-worker-thread` |
