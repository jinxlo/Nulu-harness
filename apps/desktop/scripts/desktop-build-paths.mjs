 ...
 * @returns {{ root: string, artifacts: string, runtime: string, packageSet: string, nulu: string, nuluPnpm: string, nodeExtract: string, packedDsh: string, packedVendor: string, packedLandlock: string, downloads: string }} Target paths plus the shared immutable download cache.
 */
