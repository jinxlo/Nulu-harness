...
export const en = {
  ...
  startupFailed: 'Nulu Harness could not start',
  startupLoading: 'Starting Nulu Harness…',
  ...
  updateTitle: 'Nulu Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Nulu Harness {version}\n\nThis release includes its matching nulu version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  githubUpdateAvailable: 'A new version is available',
  githubUpdateDetail: 'Nulu Harness {version} is available on GitHub.\n\nDownload it and reinstall to keep the harness current.',
  download: 'Download',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'Nulu Harness — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'Nulu Harness 无法启动',
  startupLoading: '正在启动 Nulu Harness…',
  ...
  updateTitle: 'Nulu Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Nulu Harness {version}\n\n新版本绑定匹配的 nulu，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  githubUpdateAvailable: '发现新版本',
  githubUpdateDetail: 'Nulu Harness {version} 已在 GitHub 发布。\n\n请下载并重新安装以保持最新。',
  download: '下载',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'Nulu Harness — 桌面插件',
