...
export interface NuluDesktopApi {
...
export interface NuluDesktopStartupApi extends Pick<NuluDesktopApi, 'protocolVersion' | 'locale'> {
  readonly backend: Omit<NuluDesktopApi['backend'], 'retry'>
