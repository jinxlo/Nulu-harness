 ...
 */
import DshWorker from '@worldapptechnologies/nulu-experimental-webworker-runtime/worker?worker'
import {
...
await connectWorkerHost(new DshWorker({ name: 'nulu-host' }), { image, overlays: source.overlays })
