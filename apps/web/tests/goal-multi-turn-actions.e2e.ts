...
import type {} from '@worldapptechnologies/nulu-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@worldapptechnologies/nulu-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@worldapptechnologies/nulu-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@worldapptechnologies/nulu-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@worldapptechnologies/nulu-skill-filesystem"}\n',
