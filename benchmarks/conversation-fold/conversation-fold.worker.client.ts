...
import { AssistantStreamAccumulator } from '@worldapptechnologies/nulu-llm/assistant-stream'
...
import type { ChatSnapshot } from '@worldapptechnologies/nulu-client-ui-chat/client'
import type { SessionEventLikeEntry } from '@worldapptechnologies/nulu-api-session-controller/client'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@worldapptechnologies/nulu-client-store': import.meta.resolve('@worldapptechnologies/nulu-client-store'),
  '@worldapptechnologies/nulu-llm/assistant-stream': import.meta.resolve('@worldapptechnologies/nulu-llm/assistant-stream'),
  '@worldapptechnologies/nulu-session/surface': import.meta.resolve('@worldapptechnologies/nulu-session/surface'),
  '@worldapptechnologies/nulu-token-meter/client': import.meta.resolve('@worldapptechnologies/nulu-token-meter/client'),
})
