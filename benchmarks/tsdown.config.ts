...
const shared = {
  ...
  dts: false,
  deps: {
    neverBundle: [/^@worldapptechnologies\//],
...
export default defineConfig([
  {
    ...
    outDir: '.nulu-build/active-stream-reconnect',
    clean: true,
  ...
  },
  {
    ...
    outDir: '.nulu-build/agent-continuation',
    clean: true,
  ...
  },
  {
    ...
    outDir: '.nulu-build/session-open',
    clean: true,
    tsconfig: 'tsconfig.host.json',
  },
  {
    ...
    outDir: '.nulu-build/conversation-fold',
    clean: true,
    tsconfig: 'tsconfig.client.json',
  },
])
