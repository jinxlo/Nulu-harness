...
import type { SubprocessOutcome, SubprocessTerminalHandle } from '@worldapptechnologies/nulu-subprocess'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@worldapptechnologies/nulu-terminal': import.meta.resolve('@worldapptechnologies/nulu-terminal'),
})
