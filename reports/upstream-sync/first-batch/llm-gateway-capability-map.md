...
- **Upstream files:** packages/llm/llm-gateway/src/protocols/messages/*
...
- **Upstream files:** packages/llm/llm-gateway/src/common/{files-api,file-store,file-id,upload-index}.ts
...
- **Upstream files:** packages/llm/llm-gateway/src/common/{request-files,request-extensions}.ts, packages/session/*
...
- **Upstream commits:** 06c491508f fix(llm-gateway): request image by V4.1 token grid projection
- **Upstream files:** packages/llm/llm-gateway/src/common/image-tokens.ts
...
- **Upstream files:** packages/llm/llm-gateway/src/protocols/chat-completions/{translate,sse}.ts
...
- **Upstream files:** packages/llm/llm-gateway/src/{types,serialize,translate,sse}.ts (flat)
