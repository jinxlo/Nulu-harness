...
describe('Python runtime executable assets', () => {
  it('packages the dynamically resolved web frontend distribution', () => {
    ...
    expect(result.stdout).toContain('node_modules/@worldapptechnologies/nulu-web-frontend/dist/**/*')
    expect(result.stdout).toContain('node_modules/@worldapptechnologies/nulu-skill-badge/assets/**/*')
