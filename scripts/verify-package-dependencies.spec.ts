...
describe('face-aware source classification', () => {
  ...
  it('identifies exact runtime exports without treating type imports as values', () => {
    const source = [
      ...
      "import { createLazyRequire as lazy } from '@worldapptechnologies/nulu-lazy-require'",
      "import * as lazyModule from '@worldapptechnologies/nulu-lazy-require'",
    ...
    expect(uses.map(({ specifier, exportName }) => ({ specifier, exportName }))).toEqual([
      { specifier: '@worldapptechnologies/nulu-lazy-require', exportName: '*' },
      { specifier: '@worldapptechnologies/nulu-lazy-require', exportName: 'createLazyRequire' },
