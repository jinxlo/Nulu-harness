...
import type { CordisCatalogModel, ServiceMethodEntry } from '@worldapptechnologies/nulu-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@worldapptechnologies/nulu-tool-cordis/api-catalog', '@worldapptechnologies/nulu-cordis-client-runner/client/api-catalog')
