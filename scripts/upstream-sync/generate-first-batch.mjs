...
const capabilities = [
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/protocols/messages/*'],
  ...
  },
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/common/{files-api,file-store,file-id,upload-index}.ts'],
  ...
  },
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/common/{request-files,request-extensions}.ts', 'packages/session/*'],
  ...
  },
  {
    ...
    upstream_commits: ['06c491508f fix(llm-gateway): request image by V4.1 token grid projection'],
    upstream_files: ['packages/llm/llm-gateway/src/common/image-tokens.ts'],
  ...
  },
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/protocols/chat-completions/{translate,sse}.ts'],
  ...
  },
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/{types,serialize,translate,sse}.ts (flat)'],
...
const units = [
  ...
  },
  {
    ...
    nulu_behavior: 'Nulu session-log-gateway config (not upstream session-log-gateway defaults).',
    difference: 'Nulu removed session-log-gateway; keep gateway defaults.',
    translation: 'Port; keep Nulu config defaults.',
    preserve: ['Nulu session-log-gateway defaults'],
    do_not_import: ['session-log-gateway defaults'],
  ...
  {
    id: 8, risk: 'HIGH', area: 'rename leftover subagent-nulu-sdk', group: 'subagent-nulu-sdk',
    deps: [], commits: ['(subagent-nulu-sdk upstream evolution)'],
    upstream_files: ['packages/subagent/subagent-nulu-sdk/package.json'],
    ...
    translation: 'Reject subagent-nulu-sdk; port generic SDK changes into subagent-nulu-sdk.',
    preserve: ['Nulu rename', 'nulu-5-ultra default model'],
    do_not_import: ['nulu name', 'DeepSeek SDK assumptions'],
    invariants: ['No nulu/deepseek package names', 'Nulu default model'],
    tests: ['subagent-nulu-sdk tests'],
    acceptance: 'grep -riE "nulu" packages/subagent empty; subagent-nulu-sdk builds.',
  },
  {
    id: 9, risk: 'HIGH', area: 'rename leftover plugin-package-inventory', group: 'plugin-package-inventory',
    deps: [], commits: ['(inventory upstream evolution)'],
    upstream_files: ['packages/llm/plugin-package-inventory/package.json'],
  ...
  },
  {
    ...
    upstream_files: ['packages/llm/llm-gateway/src/protocols/messages/{adapter,transport,replay}.ts'],
