...
const retainedExamples = [
  ...
  ['### Slang/jargon → Professional phrasing', 'The committed agent workflow lives in .agents/skills/nulu-translate-docs', '仓库内置的 agent 工作流见 .agents/skills/nulu-translate-docs'],
