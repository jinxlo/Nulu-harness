...
`
  ...
  it('allows Session history reads only in tests or with existing-call waivers', async () => {
    ...
    const reads = `import { Session, SessionSeq } from '@worldapptechnologies/nulu-session'
...
`
    const existing = `import { Session, SessionSeq } from '@worldapptechnologies/nulu-session'
