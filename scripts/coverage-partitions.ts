...
export const COVERAGE_PARTITIONS_ENV = 'NULU_COVERAGE_PARTITIONS'

/** Internal marker that suppresses reports and thresholds inside a partition process. */
export const COVERAGE_PARTITION_MODE_ENV = 'NULU_COVERAGE_PARTITION_MODE'

/** Environment variable overriding instrumented test, polling, and hook timeouts. */
export const COVERAGE_TEST_TIMEOUT_ENV = 'NULU_COVERAGE_TEST_TIMEOUT_MS'
