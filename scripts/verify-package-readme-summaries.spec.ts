...
describe('package README Summary limit', () => {
  ...
  it.each([
    ...
    expect(packageReadmeSummaryErrors('packages/example/example/README.md', readme(summary, kind))).toEqual([
      `packages/example/example/README.md: Summary has 101 words; the limit is 100. Read .agents/skills/nulu-doc/SKILL.md and .agents/skills/nulu-doc/templates/${kind}.md before rewriting it.`,
    ])
  })
