...
export default defineConfig([
  ...
  { entry: { process: 'lib/types/process-entry.js' }, outDir: 'lib', format: ['esm'], platform: 'node', target: 'es2024', fixedExtension: false, dts: false, clean: false, noExternal: ['@worldapptechnologies/nulu-subprocess/control'] },
])
