/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-settings`.
 * @module @worldapptechnologies/nulu-settings/invariant
 */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-settings'
