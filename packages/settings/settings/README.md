...
# @worldapptechnologies/nulu-settings
...
`ctx.settings` appears once the provider is live. The provider README owns the full configuration surface; the generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-settings-file) lists every accepted field.
