 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the Nulu function-name
...
import { isImageAdmissionError } from '@worldapptechnologies/nulu-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@worldapptechnologies/nulu-attachment'
import type { ContentBlock } from '@worldapptechnologies/nulu-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@worldapptechnologies/nulu-tools'
import { assertSupportedJsonSchema } from '@worldapptechnologies/nulu-tools'
import type { JsonSchemaNode } from '@worldapptechnologies/nulu-tools'
...
/**
 * Nulu function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** Nulu function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the Nulu function-name contract (64 chars,
