...
The generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-tool-jobs) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-jobs) — the exact `job_output`, `job_list`, and `job_kill` schemas.
- [Generated configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-tool-jobs) — every accepted config field and its source declaration.
...
The generated [`job_output`, `job_list`, and `job_kill` schemas](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-jobs) while this tool set is visible.
