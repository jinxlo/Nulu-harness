/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-storage-domain`: every
 ...
 * @module @worldapptechnologies/nulu-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-storage-domain'
