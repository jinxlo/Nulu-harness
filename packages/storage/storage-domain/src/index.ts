 ...
 * @module @worldapptechnologies/nulu-storage-domain
 */

import type { Context } from '@worldapptechnologies/cordis'
import z from '@worldapptechnologies/schemastery'
import { storageBackendServiceKey } from '@worldapptechnologies/nulu-storage'
...
declare module '@worldapptechnologies/nulu-storage' {
