...
The generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-storage-domain) is the exhaustive source for every accepted field and its JSDoc.
