 ...
 * @module @worldapptechnologies/nulu-terminal-bash
 */

import { Context } from '@worldapptechnologies/cordis'
import type { Agent } from '@worldapptechnologies/nulu-agent'
import type { Session, SessionEvent } from '@worldapptechnologies/nulu-session'
import { TerminalBackendCleanupError } from '@worldapptechnologies/nulu-terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec, TerminalSendOperation } from '@worldapptechnologies/nulu-terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@worldapptechnologies/nulu-subprocess'
...
function childEnvironment(spec: TerminalBackendSpawnSpec, dialect: ShellDialect): Record<string, string> {
  ...
  const common = {
    ...
    GIT_PAGER: 'cat',
    NULU_SHELL: '1',
    NULU_SESSION_ID: spec.owner.id,
    NULU_PTY_SESSION_ID: spec.sessionId,
  }
  if (dialect === 'pwsh') {
