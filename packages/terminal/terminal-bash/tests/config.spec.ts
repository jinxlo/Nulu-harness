...
import type { Config } from '@worldapptechnologies/nulu-terminal-bash/src/config.ts'
import { resolveConfig, validateConfig } from '@worldapptechnologies/nulu-terminal-bash/src/config.ts'
