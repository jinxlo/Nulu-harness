 ...
 * @module @worldapptechnologies/nulu-tool-terminal
 */
...
import { TerminalSessionId } from '@worldapptechnologies/nulu-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@worldapptechnologies/nulu-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @worldapptechnologies/nulu-jobs and @worldapptechnologies/nulu-tool-jobs')
