import { ToolCallId, createUserMessage, expandAssistantStream } from '@worldapptechnologies/nulu-llm'
/**
 ...
 * @module nulu-agent-loop/tests/cancel
 */

import { describe, expect, it } from 'vitest'
import { Context } from '@worldapptechnologies/cordis'
import LlmRuntime from '@worldapptechnologies/nulu-llm'
import SessionStore, { Session, SessionId, SessionLogOffset, TurnEndReason } from '@worldapptechnologies/nulu-session'
import SystemPrompt from '@worldapptechnologies/nulu-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED_BEFORE_DISPATCH } from '@worldapptechnologies/nulu-tools'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // nulu-llm-retry opens when its backoff waits after appending llm/retry.
