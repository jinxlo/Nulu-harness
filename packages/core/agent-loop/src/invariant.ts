 ...
 * @module @worldapptechnologies/nulu-agent-loop/invariant
 */

import type { Context } from '@worldapptechnologies/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@worldapptechnologies/nulu-llm'
import type { InvariantFailure, InvariantInstaller } from '@worldapptechnologies/nulu-invariants'
import { foldRequestHeader } from '@worldapptechnologies/nulu-session'

const PACKAGE_NAME = '@worldapptechnologies/nulu-agent-loop'
