/** Package-owned scoped-dispatch invariants. @module @worldapptechnologies/nulu-scope/invariant */

import type { Context } from '@worldapptechnologies/cordis'
import type { InvariantInstaller } from '@worldapptechnologies/nulu-invariants'
import { carrierKeyOf, isScopeCarrier } from '@worldapptechnologies/nulu-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@worldapptechnologies/nulu-scope'
