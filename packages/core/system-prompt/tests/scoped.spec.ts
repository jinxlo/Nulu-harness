...
import { createScope, scopeOf } from '@worldapptechnologies/nulu-scope'
import type { Scope, ScopeKey } from '@worldapptechnologies/nulu-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@worldapptechnologies/nulu-system-prompt'
import type { Config, PromptAssembly } from '@worldapptechnologies/nulu-system-prompt'
