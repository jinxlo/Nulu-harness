/** Package-owned prompt-assembly invariants. @module @worldapptechnologies/nulu-system-prompt/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-system-prompt'
