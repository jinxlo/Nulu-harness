 ...
 *
 * @module @worldapptechnologies/nulu-system-prompt
 */

import { Context, Service } from '@worldapptechnologies/cordis'
import z from '@worldapptechnologies/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@worldapptechnologies/nulu-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@worldapptechnologies/nulu-scope'
import type { ContextSnapshotSection, ToolSchema } from '@worldapptechnologies/nulu-llm'
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        text: 'You are an AI agent powered by Nulu Harness.',
      })
    }
    this.section({
