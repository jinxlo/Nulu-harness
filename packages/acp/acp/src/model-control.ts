...
import { installModelSelection, type ModelSelection, type ModelSelectionRef } from '@worldapptechnologies/nulu-agent'
import { ReasoningEffortId, type LlmCallConfig, type LlmRuntime } from '@worldapptechnologies/nulu-llm'

const MODEL_CONFIG_ID = 'model'
const REASONING_CONFIG_ID = 'reasoning_effort'
// NULU reasoning effort ids are non-empty, so the empty opaque ACP value is a disjoint provider-default choice.
