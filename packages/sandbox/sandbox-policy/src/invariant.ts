/** Package-owned session-event invariants for sandbox policy. @module @worldapptechnologies/nulu-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-sandbox-policy'
