...
import type { NativePtr, Win32ProcessBindings } from '@worldapptechnologies/nulu-win32-process'
...
export type { NativePtr } from '@worldapptechnologies/nulu-win32-process'
