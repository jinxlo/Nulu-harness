 ...
 * (`@worldapptechnologies/nulu-sandbox-local`) and the in-process filesystem fence
 * (`@worldapptechnologies/nulu-fs-sandbox`) both derive their allow-list here, so "the
