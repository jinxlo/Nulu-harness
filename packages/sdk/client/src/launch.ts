 ...
 */
export function resolveDshBinFromManifests(nuluManifestUrl: string, clientManifestUrl: string): string {
...
export function resolveDshNodeLaunchFromManifests(
  ...
  const bin = resolveDshBinFromManifests(nuluManifestUrl, clientManifestUrl)
