 ...
 * `@worldapptechnologies/nulu-spill` storage seam. Persists oversized text to a
 ...
 *
 * @module @worldapptechnologies/nulu-spill-local
 */
...
export class LocalSpillStore extends SpillStore {
   ...
   * `nulu-spill-*` temp root (see {@link discoverDefaultRoots}), pruned when
  ...
  /**
   * The directory scanned for prior default `nulu-spill-*` roots — the OS tmpdir,
