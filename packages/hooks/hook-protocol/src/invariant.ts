/** Package-owned hook invocation/result stream invariants. @module @worldapptechnologies/nulu-hook-protocol/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-hook-protocol'
