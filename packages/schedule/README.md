...
- [Generated tool catalog](../../docs/tool-catalog.md#worldapptechnologiesnulu-schedule) — the `schedule_create`/`schedule_list`/`schedule_delete` schemas the model receives.
