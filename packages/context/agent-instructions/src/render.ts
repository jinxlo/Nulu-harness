 ...
 *
 * @module @worldapptechnologies/nulu-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$NULU_HOME`.
 * Discovery (`$NULU_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.nulu/AGENTS.md' || displayPath === '$NULU_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
