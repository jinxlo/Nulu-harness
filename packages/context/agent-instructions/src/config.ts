 ...
 *
 * @module @worldapptechnologies/nulu-agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'nuluHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    nuluHome: resolveNuluHome(config.nuluHome),
