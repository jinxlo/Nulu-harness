...
```yaml
- name: '@worldapptechnologies/nulu-file-reference-local'
  config:
    maxResults: 20
```
...
- [Filesystem tool catalog](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-fs) — the `read` tool whose namespace discovery must match.
