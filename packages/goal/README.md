...
- [Generated tool catalog](../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#worldapptechnologiesnulu-goal) — every accepted config field of the goal service.
