/** Package-owned goal-round prompt invariants. @module @worldapptechnologies/nulu-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@worldapptechnologies/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@worldapptechnologies/nulu-goal'
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-goal-round-driver'
