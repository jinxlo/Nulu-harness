...
import * as GoalSessionInvariant from '@worldapptechnologies/nulu-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@worldapptechnologies/nulu-goal-round-driver'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@worldapptechnologies/nulu-goal-round-driver',
    }))
  })
