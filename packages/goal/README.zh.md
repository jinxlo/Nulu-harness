...
- [生成的工具目录](../../docs/tool-catalog.zh.md#worldapptechnologiesnulu-tool-goal)——模型接收的三个目标工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#worldapptechnologiesnulu-goal)——目标服务的每个受支持配置字段。
