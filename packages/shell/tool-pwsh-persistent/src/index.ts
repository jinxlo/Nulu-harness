 ...
 * @module @worldapptechnologies/nulu-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@worldapptechnologies/nulu-terminal'
...
const SHELL_PROMPT = '__NULU_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__NULU_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__NULU_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
