 ...
 * mirror of `@worldapptechnologies/nulu-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @worldapptechnologies/nulu-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@worldapptechnologies/nulu-shell'
import type { RunnerFailureRule } from '@worldapptechnologies/nulu-sandbox'
