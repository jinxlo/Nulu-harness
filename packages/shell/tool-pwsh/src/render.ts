 ...
 * `nulu-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @worldapptechnologies/nulu-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@worldapptechnologies/nulu-shell'
...
/* jscpd:ignore-start -- deliberate twin of nulu-tool-bash/render.ts (Agent Note). */
