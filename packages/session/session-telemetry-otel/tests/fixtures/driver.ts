...
process.env.NULU_TELEMETRY_E2E_URL = `http://127.0.0.1:${address.port}/v1/logs`
process.env.NULU_TELEMETRY_OTLP_URL = process.env.NULU_TELEMETRY_E2E_URL
process.env.NULU_TELEMETRY_MODE = process.env.NULU_TELEMETRY_E2E_MODE ?? 'FEEDBACK_ONLY'
...
try {
  ...
  try {
    ...
    if (process.env.NULU_TELEMETRY_E2E_FEEDBACK !== 'none') {
