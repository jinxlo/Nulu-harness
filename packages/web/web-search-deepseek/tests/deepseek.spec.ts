...
} from '@worldapptechnologies/nulu-web-search-deepseek'
import * as deepseekPlugin from '@worldapptechnologies/nulu-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@worldapptechnologies/nulu-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@worldapptechnologies/nulu-web-search-deepseek'
