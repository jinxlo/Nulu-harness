...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@worldapptechnologies/nulu-tools'
import type { WebFetchBody, WebFetchResult } from '@worldapptechnologies/nulu-web'
 ...
 * `@worldapptechnologies/nulu-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@worldapptechnologies/nulu-tool-call-timeout-policy` to enforce.
