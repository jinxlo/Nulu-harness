/**
 * Provider-private wire types for Nulu's Anthropic-compatible Messages API. Citeable
 ...
 * @module @worldapptechnologies/nulu-web-search-gateway/types
 */
...
/** Nulu's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** Nulu's error response envelope (best-effort; fields vary). */
