...
import { NuluSearchProvider } from '../src/provider.ts'
describe('nulu search egress', () => {
  it('goes through the proxy', async () => {
    const p = new NuluSearchProvider(() => ({ apiKey: 'probe', baseURL: 'http://dsk-probe.invalid', model: 'm', apiVersion: '2023-06-01', maxTokens: 16, maxUses: 1 }))
