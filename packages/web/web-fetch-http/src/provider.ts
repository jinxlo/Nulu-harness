 ...
 * and leaves presentation to `@worldapptechnologies/nulu-tool-web`. Requests carry no browser cookies
 * or ambient credentials.
 * @module @worldapptechnologies/nulu-web-fetch-http/provider
 */

import { WebError } from '@worldapptechnologies/nulu-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@worldapptechnologies/nulu-web'
