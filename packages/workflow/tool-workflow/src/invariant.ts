/** Package-owned durable workflow-record invariants. @module @worldapptechnologies/nulu-tool-workflow/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-tool-workflow'
