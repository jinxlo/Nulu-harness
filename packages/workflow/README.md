...
- [Generated tool catalog](../../docs/tool-catalog.md#worldapptechnologiesdsh-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#worldapptechnologiesdsh-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#worldapptechnologiesdsh-workflow-ptc) — every accepted engine config field.
