...
describe('credentials invariant companion', () => {
  ...
  it('fails an update event emitted without a live service', async () => {
    ...
    expect(() => { ctx.emit('credentials/reference-updated', REF) }).toThrow(/invariant violated by "@worldapptechnologies\/nulu-credentials"/)
  })
  ...
  it('reserves the package name against duplicate registration', async () => {
    ...
    expect(() => {
      ctx.invariants.register('@worldapptechnologies/nulu-credentials', () => {})
