/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-credentials`.
 * @module @worldapptechnologies/nulu-credentials/invariant
 */

import type { Context } from '@worldapptechnologies/cordis'
import type { InvariantFailure, InvariantInstaller } from '@worldapptechnologies/nulu-invariants'

const PACKAGE_NAME = '@worldapptechnologies/nulu-credentials'
