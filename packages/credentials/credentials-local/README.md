...
|---|---|---|
| The environment you launched in (`DEEPSEEK_API_KEY=… nulu`) | no | everything |
...
- **A key the launching environment supplies is read-only** — `DEEPSEEK_API_KEY=… nulu` wins for this run; saving or removing it is refused. Clear the variable in the launching shell first.
