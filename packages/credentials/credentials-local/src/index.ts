 ...
 * ```
 *
 * The inherited environment wins because `DEEPSEEK_API_KEY=… nulu`, a CI
...
import { canonicalizeWatchPath, resolveDshHome } from '@worldapptechnologies/nulu-home-paths'
...
export function resolveSpec(config: Config): ResolvedSpec {
  return {
    filename: resolve(config.path ?? join(resolveDshHome(config.nuluHome), CREDENTIALS_FILENAME)),
