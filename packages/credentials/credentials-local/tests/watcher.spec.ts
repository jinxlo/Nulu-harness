...
const KEY = credentialRef('NULU_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'nulu-credentials-watch-'))
