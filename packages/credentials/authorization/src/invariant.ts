/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-authorization`.
 * @module @worldapptechnologies/nulu-authorization/invariant
 */

import type { Context } from '@worldapptechnologies/cordis'
import type { InvariantFailure, InvariantInstaller } from '@worldapptechnologies/nulu-invariants'

const PACKAGE_NAME = '@worldapptechnologies/nulu-authorization'
