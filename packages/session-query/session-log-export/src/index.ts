...
import type { CommandDefinitionId } from '@worldapptechnologies/nulu-commands/brand'
...
import type { CommandResult } from '@worldapptechnologies/nulu-commands'
...
export function apply(ctx: Context, config: Config = {}): void {
  ctx.effect(() => ctx.commands.register({
    definitionId: brandString<CommandDefinitionId>('@worldapptechnologies/nulu-session-log-export'),
    name: 'export',
