...
The generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-api-session-controller) is the exhaustive source for accepted fields and their JSDoc.
