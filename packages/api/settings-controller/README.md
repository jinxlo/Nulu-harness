...
The generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-api-settings-controller) is the exhaustive source for accepted fields and their JSDoc.
