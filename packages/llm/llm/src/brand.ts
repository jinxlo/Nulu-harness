/**
 * nulu-llm's owned branded ids: tool-call correlation and provider request
 * diagnostics.
 *
 * The `Branded<B>` primitive and stateless constructor live in
 * `@worldapptechnologies/nulu-brand` so every owner of a cross-boundary id can brand it
 * without depending on nulu-llm; see that package's README for the
 * nominal-typing policy.
 *
 * @module @worldapptechnologies/nulu-llm/brand
 */
