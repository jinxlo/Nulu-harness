 ...
 * @module nulu-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by nulu-agent-loop. */
...
/**
 * Mark one exact request object as assembled by nulu-agent-loop.
...
/**
 * Test whether the exact request object was assembled by nulu-agent-loop.
