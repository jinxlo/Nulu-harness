...
import { BlockAssembler, ToolCallId, type StreamChunk } from '@worldapptechnologies/nulu-llm'
...
describe('assertNever', () => {
  it('throws with diagnostics when a value escapes a closed union at runtime', async () => {
    const { assertNever } = await import('@worldapptechnologies/nulu-util-values')
