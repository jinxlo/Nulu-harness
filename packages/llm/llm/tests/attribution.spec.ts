...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@worldapptechnologies/nulu-llm'
import type { AppIdentity } from '@worldapptechnologies/nulu-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `nulu-harness/${manifest.version} (+https://github.com/worldapptechnologies/nulu-harness)`,
    )
  })
