...
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@worldapptechnologies/nulu-authorization'
...
async function harness(): Promise<Context> {
  const dir = await mkdtemp(join(tmpdir(), 'nulu-pi-login-'))
  dirs.push(dir)
