 ...
 *
 * @module nulu-llm-pi-ai/replay
 */

import { LlmError } from '@worldapptechnologies/nulu-llm'
import type { Message, ModelMessageSource, ReplayEnvelope } from '@worldapptechnologies/nulu-llm'
...
function foreignAssistant(message: Message): AssistantMessage {
  ...
  return {
    ...
    api: 'nulu-foreign',
    provider: source?.provider ?? 'nulu-foreign',
    model: source?.model ?? 'nulu-foreign',
    usage: emptyPiUsage(),
