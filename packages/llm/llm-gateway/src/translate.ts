/**
 * Translate Nulu SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate Nulu wire chunks into the harness `StreamChunk` protocol.
 * @module nulu-llm-gateway/translate
 */
...
/**
 * Map wire usage fields. Nulu's `prompt_tokens` INCLUDES cache hits
