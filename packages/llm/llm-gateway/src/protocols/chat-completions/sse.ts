 ...
 * Nulu protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module nulu-llm-gateway/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@worldapptechnologies/nulu-llm'

/** The terminal payload Nulu (and OpenAI) send after the last chunk. */
