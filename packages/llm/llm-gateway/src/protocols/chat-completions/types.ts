/**
 * Nulu chat-completions wire format (OpenAI-compatible). Types only.
 *
...
export interface WireAssistantMessage {
   ...
   * guides/thinking_mode.mdx § Tool Calls); Nulu ignores it elsewhere,
