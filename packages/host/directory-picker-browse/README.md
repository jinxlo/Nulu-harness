...
The generated [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-host-directory-picker-browse) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-host-directory-picker-browse) — every accepted config field and its source declaration.
