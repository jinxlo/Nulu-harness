...
import { DirectoryPickerError } from '@worldapptechnologies/nulu-host-directory-picker'
import type { DirectoryPickerBrowseCapability } from '@worldapptechnologies/nulu-host-directory-picker'
...
beforeAll(async () => {
  root = await mkdtemp(join(tmpdir(), 'nulu-browse-'))
