...
/**
 * Tail script settling the boot-readiness deferred (`__NULU_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__NULU_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
