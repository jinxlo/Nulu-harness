 ...
 * @module @worldapptechnologies/nulu-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@worldapptechnologies/nulu-host-directory-picker-native',
  browse: '@worldapptechnologies/nulu-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@worldapptechnologies/nulu-client-ui-directory-picker-native',
  browse: '@worldapptechnologies/nulu-client-ui-directory-picker-browse',
}
