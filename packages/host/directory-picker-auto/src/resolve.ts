 ...
 * @module @worldapptechnologies/nulu-host-directory-picker-auto/resolve
 */

import type { Config as HttpServerConfig } from '@worldapptechnologies/nulu-host-webserver'
