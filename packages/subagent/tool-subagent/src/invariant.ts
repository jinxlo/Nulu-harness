/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-tool-subagent`.
 * @module @worldapptechnologies/nulu-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-tool-subagent'
