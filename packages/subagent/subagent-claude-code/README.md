...
- [Generated configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-subagent-claude-code) — every accepted config field and its source declaration.
