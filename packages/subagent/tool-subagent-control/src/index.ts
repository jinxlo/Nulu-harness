 ...
 * `@worldapptechnologies/nulu-tool-subagent` instances so multiple delegation tools share
 * one control API.
 * @module @worldapptechnologies/nulu-tool-subagent-control
 */
...
import { markAdjacentAgentSendMessageTool } from '@worldapptechnologies/nulu-subagent/internal'
