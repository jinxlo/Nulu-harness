 ...
 * @module @worldapptechnologies/nulu-tool-subagent-control/list-agents
 */
...
import type { SubagentDescendantListEntry, SubagentListEntry } from '@worldapptechnologies/nulu-subagent'
