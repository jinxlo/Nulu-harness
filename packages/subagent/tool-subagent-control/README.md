...
- [nulu-tool-subagent](../tool-subagent/README.md) — the delegation tool that starts continuable children.
- [Generated tool catalog](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-subagent-control) — the three tool schemas.
...
The generated [schemas](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-subagent-control): `send_message` takes `agent_id` and `message`; `interrupt_agent` takes `agent_id`; `list_agents` takes the optional `scope` enum.
