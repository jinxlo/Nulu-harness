 ...
 * (`@worldapptechnologies/nulu-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@worldapptechnologies/nulu-tool-subagent`) are separate packages.
 *
