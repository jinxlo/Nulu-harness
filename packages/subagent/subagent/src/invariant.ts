/** Package-owned subagent registry and lifecycle invariants. @module @worldapptechnologies/nulu-subagent/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-subagent'
