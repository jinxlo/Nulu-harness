...
import type { SessionProjectionRegistry } from '@worldapptechnologies/nulu-session-projection'
import type { SessionProjectionCache } from '@worldapptechnologies/nulu-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @worldapptechnologies/nulu-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @worldapptechnologies/nulu-session)',
  ...
  if (query === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionQuery service (load @worldapptechnologies/nulu-session-query)',
