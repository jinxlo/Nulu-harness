...
- **Saved settlement notices are not rewritten** — a saved user-role notice containing reasoning still fails Nulu Messages serialization while it remains in the parent's request history.
