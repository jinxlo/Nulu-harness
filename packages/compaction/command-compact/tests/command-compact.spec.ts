...
import CommandRuntime, { type CommandResult } from '@worldapptechnologies/nulu-commands'
import {
  CompactionId,
  CompactionEngine,
...
import { Session, SessionId, SessionSeq } from '@worldapptechnologies/nulu-session'
import * as commandCompact from '@worldapptechnologies/nulu-command-compact'
...
describe('@worldapptechnologies/nulu-command-compact registration', () => {
  it('registers one argument-free command with Loader-safe exports and disposes it', async () => {
    ...
    expect(test.ctx.commands.list(test.agent)).toContainEqual({
      definitionId: '@worldapptechnologies/nulu-command-compact',
      name: 'compact',
