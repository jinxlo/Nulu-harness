...
import ToolResultPruner, {
  ...
  PRUNE_MARKER,
  resolveConfig,
} from '@worldapptechnologies/nulu-compaction-tool-result-pruner'
import type { ToolResultPruneConfig } from '@worldapptechnologies/nulu-compaction-tool-result-pruner'
