 ...
 * @module @worldapptechnologies/nulu-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@worldapptechnologies/cordis'
import { AttachmentError, AttachmentId } from '@worldapptechnologies/nulu-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@worldapptechnologies/nulu-attachment'
import type { ContentBlock } from '@worldapptechnologies/nulu-llm'
import { defineTool } from '@worldapptechnologies/nulu-tools'
import type { GenericCallView, ToolExecution } from '@worldapptechnologies/nulu-tools'
