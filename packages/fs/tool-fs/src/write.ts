 ...
 * @module @worldapptechnologies/nulu-tool-fs/src/write
 */

import type { Context } from '@worldapptechnologies/cordis'
import { defineTool } from '@worldapptechnologies/nulu-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@worldapptechnologies/nulu-tools'
import type { FsWriteOutcome } from '@worldapptechnologies/nulu-fs'
