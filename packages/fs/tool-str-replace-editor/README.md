...
- [nulu-fs](../fs/README.md) — the `ctx.fs` contract this tool consumes.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-str-replace-editor) — the exhaustive schema this package registers.
...
The generated [`str_replace_editor` schema](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-str-replace-editor), including the configured `description`. The plugin contributes no standalone system-prompt section.
