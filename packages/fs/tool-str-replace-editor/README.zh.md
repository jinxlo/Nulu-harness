...
- [nulu-fs](../fs/README.zh.md)——本工具消费的 `ctx.fs` 约定。
...
- [生成工具目录](../../../docs/tool-catalog.zh.md#worldapptechnologiesnulu-tool-str-replace-editor)——本包注册的穷尽式 schema。
...
生成的 [`str_replace_editor` schema](../../../docs/tool-catalog.zh.md#worldapptechnologiesnulu-tool-str-replace-editor)，包含配置的 `description`。本插件不贡献独立系统提示词段。
