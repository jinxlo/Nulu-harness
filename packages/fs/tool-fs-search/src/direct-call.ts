/** Shared top-level-call post-policy selection for search result spill. @module nulu-tool-fs-search/direct-call */

import type { Context } from '@worldapptechnologies/cordis'
import type { PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@worldapptechnologies/nulu-tools'
