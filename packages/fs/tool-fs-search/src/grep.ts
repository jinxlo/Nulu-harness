 ...
 *
 * @module @worldapptechnologies/nulu-tool-fs-search/grep
 */

import type { Context } from '@worldapptechnologies/cordis'
import { defineTool } from '@worldapptechnologies/nulu-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@worldapptechnologies/nulu-tools'
import type { RetainedItems } from '@worldapptechnologies/nulu-output-retention'
import type { SpillRef } from '@worldapptechnologies/nulu-spill'
