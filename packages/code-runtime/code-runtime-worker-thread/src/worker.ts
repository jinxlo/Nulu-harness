 ...
 * @module @worldapptechnologies/nulu-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('nulu-code-runtime-worker-thread: worker entry loaded outside a worker thread')
