/** JSON string-prefix accounting for the outer-output ledger. @module @worldapptechnologies/nulu-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@worldapptechnologies/nulu-code-runtime'
