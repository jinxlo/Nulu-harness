 ...
 * @module @worldapptechnologies/nulu-client-test-runtime/src/assembly/modules
 */
import * as modulesClient from '@worldapptechnologies/nulu-client-modules/client'
import { createClientModuleSystem } from '@worldapptechnologies/nulu-client-modules/client'
import type { ClientModuleLoader, ClientModuleLoaderTarget, WebBootGraph } from '@worldapptechnologies/nulu-client-modules/client'
...
export const MODULES_PACKAGE = '@worldapptechnologies/nulu-client-modules'
 ...
 * statically imported `@worldapptechnologies/nulu-client-modules/client` namespace.
