...
import { createClientModuleSystem, parseBootManifest, type ClientBundleRegistration, type ClientModuleLoaderTarget } from '@worldapptechnologies/nulu-client-modules/client'
...
describe('ClientRoster', () => {
  ...
  it('closure treats the platform seed modules as satisfied without a row', () => {
    const seeded = { name: 'seeded', inject: ['@worldapptechnologies/nulu-client-ui-primitives', 'react', 'a'], immediately: false }
