 ...
 * @module @worldapptechnologies/nulu-cordis-host-runner/guard
 */

import { Context } from '@worldapptechnologies/cordis'
import type { Plugin } from '@worldapptechnologies/cordis'
import { scopeOf } from '@worldapptechnologies/nulu-scope'
import { assertSupportedJsonSchema, defineTool } from '@worldapptechnologies/nulu-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@worldapptechnologies/nulu-cordis-client-runner`, whose CTX_VERBS names this one its
