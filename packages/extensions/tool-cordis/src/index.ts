 ...
 * @module @worldapptechnologies/nulu-tool-cordis
 */
...
} from '@worldapptechnologies/nulu-cordis-host-runner'
import type { DynamicCordisReference } from '@worldapptechnologies/nulu-cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the NULU process restarted.',
