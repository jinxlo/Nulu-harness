...
import { HOST_BUILTIN_INSPECTION } from '@worldapptechnologies/nulu-cordis-host-runner'
import type { HostCordisInspectProviderRegistration } from '@worldapptechnologies/nulu-cordis-host-runner'
