...
export function profileWorkerBanner(format: 'cjs' | 'esm'): string {
  return format === 'cjs'
    ? '"use strict";\nrequire("@worldapptechnologies/nulu-app-boot/worker/profile-resolution-bootstrap");'
    : 'import "@worldapptechnologies/nulu-app-boot/worker/profile-resolution-bootstrap";'
}
