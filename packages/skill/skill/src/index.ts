 ...
 * Concrete
 * providers such as `@worldapptechnologies/nulu-skill-filesystem` decide where skills come
 ...
 *
 * @module @worldapptechnologies/nulu-skill
 */

import { Context, Service } from '@worldapptechnologies/cordis'
import type {} from '@worldapptechnologies/nulu-llm'
import { assertNever } from '@worldapptechnologies/nulu-util-values'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@worldapptechnologies/nulu-scope'
...
export type SkillSource = 'project-nulu' | 'project-agents' | 'runtime' | 'user-nulu' | 'user-agents' | 'custom' | 'bundled' | (string & {})
