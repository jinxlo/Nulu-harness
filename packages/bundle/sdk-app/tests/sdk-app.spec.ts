...
describe('nulu-sdk-app bundle', () => {
  it('declares startup-gated JSON-RPC serving without overriding base HMR policy', () => {
    ...
    expect(manifest.dependencies).toHaveProperty('@worldapptechnologies/nulu-sdk-jsonrpc-server')
    ...
    expect(rows.find(row => row.id === 'sdk-app-startup')?.name).toBe('@worldapptechnologies/nulu-sdk-app')
