...
- **A profile can omit the SDK server** — a custom profile selected by the TypeScript client must retain this bundle or another `nulu-sdk-jsonrpc-server` row; client initialization fails when no peer answers.
