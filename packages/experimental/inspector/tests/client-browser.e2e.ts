...
<script>
globalThis.__NULU_INSPECTOR__ = ${JSON.stringify(bootstrap)};
globalThis.__NULU_BOOT__ = ${JSON.stringify(boot)};
...
const plugin = registration.factory(specifier => {
  if (specifier === '@worldapptechnologies/cordis') return cordis;
