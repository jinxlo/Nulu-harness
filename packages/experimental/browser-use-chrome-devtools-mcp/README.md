...
- name: '@worldapptechnologies/nulu-experimental-browser-use-chrome-devtools-mcp'
  config:
    mode: launch
    headless: true
```
...
The [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesnulu-experimental-browser-use-chrome-devtools-mcp) lists accepted fields. The profile or preset selects the browser mode.
