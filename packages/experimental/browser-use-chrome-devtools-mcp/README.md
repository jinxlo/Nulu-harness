...
The [configuration catalog](../../../docs/config-catalog.md#worldapptechnologiesdsh-experimental-browser-use-chrome-devtools-mcp) lists accepted fields. The profile or preset selects the browser mode.
