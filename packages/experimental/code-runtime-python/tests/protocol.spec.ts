...
describe('logTruncationMarker', () => {
  it('names the configured byte budget', () => {
    expect(logTruncationMarker(65536)).toBe('[nulu-code-runtime-python] log capture truncated at 65536 bytes')
    expect(logTruncationMarker(1)).toBe('[nulu-code-runtime-python] log capture truncated at 1 bytes')
  })
})
