...
check('WRAPPER_PARAMS is the frozen 7-parameter shape', [...WRAPPER_PARAMS], [
  'exports', 'require', 'module', '__filename', '__dirname', '__nulu$meta', '__als',
])
...

{
  ...
  contains('import.meta becomes the wrapper parameter', code, '__nulu$meta')
...

{
  ...
  contains('dynamic import becomes the helper call', code, '__nulu$dynImport')
...

{
  ...
  contains('trap 1: dynamic import in a CommonJS file is still rewritten', code, '__nulu$dynImport')
...

{
  ...
  const code = transformModule(source, 'probe.js')
  lacks('trap 6: a method named import is not rewritten', code, '__nulu$dynImport')
...

{
  ...
  lacks('trap 8: new.target is not replaced by the meta parameter', code, '__nulu$meta')
