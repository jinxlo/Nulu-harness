 ...
 * @module @worldapptechnologies/nulu-experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like nulu-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/nulu', vfs = new MemoryVfs()): MemoryVfs {
