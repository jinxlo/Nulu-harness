 ...
 * @module @worldapptechnologies/nulu-experimental-webworker-runtime/src/storage/types
 */
 ...
 *
 * The filesystem service (`nulu-fs-local`) stats every target this way and then
