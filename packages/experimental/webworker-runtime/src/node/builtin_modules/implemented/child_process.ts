 ...
 * @module @worldapptechnologies/nulu-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { NULU_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? NULU_ROOT
