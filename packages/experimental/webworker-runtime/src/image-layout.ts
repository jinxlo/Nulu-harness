...
export const DEFAULT_ROOT = '/nulu'
...
/** Home directory under the root; the process shim's `NULU_HOME`/`HOME` default. */
 ...
 */
export const LOWERING_VERSION = 'nulu-worker-transform/1'
