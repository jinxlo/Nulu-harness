...
describe('Agent Teams Web profile bundle', () => {
  it('declares a public parseable layer containing the Team UI', () => {
    ...
    expect(manifest.dependencies).toEqual({
      '@worldapptechnologies/nulu-experimental-client-ui-agent-team': 'workspace:^',
    })
    ...
    expect(parsed.flatMap(patch => patch.insert ?? [])).toEqual([
      { id: 'ui-agent-team', name: '@worldapptechnologies/nulu-experimental-client-ui-agent-team' },
    ])
  })
})
