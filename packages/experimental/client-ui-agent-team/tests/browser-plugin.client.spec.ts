...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@worldapptechnologies/nulu-experimental-agent-team/client'
import type {} from '@worldapptechnologies/nulu-experimental-agent-team/remote'
import { RemoteError } from '@worldapptechnologies/nulu-client-test-runtime'
import type { TypertRemoteContribution } from '@worldapptechnologies/nulu-typert-protocol'
...
const REMOTE: TypertRemoteContribution = {
  package: '@worldapptechnologies/nulu-experimental-agent-team',
  descriptors: [],
}
