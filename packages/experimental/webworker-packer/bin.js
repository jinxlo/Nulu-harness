#!/usr/bin/env node
/**
 * Stable link target for the `nulu-pack-vfs-image` bin, forwarding to the build
 * product.
 *
 ...
 * @module @worldapptechnologies/nulu-experimental-webworker-packer/bin
 */
...
if (!existsSync(fileURLToPath(entry))) {
  process.stderr.write('nulu-pack-vfs-image: lib/bin.js is missing — run `pnpm run build` before packing an image\n')
  process.exit(1)
}
