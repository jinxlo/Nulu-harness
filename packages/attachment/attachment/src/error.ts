/** Attachment failure class. @module @worldapptechnologies/nulu-attachment/error */
 ...
 * the base lives in `@worldapptechnologies/nulu-llm`, which itself depends on this
