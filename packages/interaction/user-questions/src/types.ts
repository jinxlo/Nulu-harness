/** Client-safe question, answer, and event types. @module @worldapptechnologies/nulu-user-questions/types */

import type { Scoped } from '@worldapptechnologies/nulu-scope'
import type { Agent } from '@worldapptechnologies/nulu-agent/types'
