/** Package-owned approval audit-stream invariants. @module @worldapptechnologies/nulu-user-approval/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-user-approval'
