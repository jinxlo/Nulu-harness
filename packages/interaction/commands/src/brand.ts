 ...
 *
 * The `Branded<B>` primitive lives in `@worldapptechnologies/nulu-brand`; this module
 ...
 * loading the host plugin's Context merges — the `nulu-llm/brand` shape.
 *
 * @module @worldapptechnologies/nulu-commands/brand
 */
