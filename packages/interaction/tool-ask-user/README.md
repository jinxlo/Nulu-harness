...
- [Tool catalog](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-ask-user) — the generated `ask_user_question` schema.
...
The model sees the generated [`ask_user_question` schema](../../../docs/tool-catalog.md#worldapptechnologiesnulu-tool-ask-user), including question ids, prompts, headings, options, and multi-select flags.
