...
- [工具目录](../../../docs/tool-catalog.zh.md#worldapptechnologiesnulu-tool-ask-user)——生成的 `ask_user_question` schema。
...
模型会看到生成的 [`ask_user_question` schema](../../../docs/tool-catalog.zh.md#worldapptechnologiesnulu-tool-ask-user)，其中包含问题 id、提示语、标题、选项与多选标志。
