 ...
 * @module @worldapptechnologies/nulu-fs-e2b
 */
...
import type { EntryInfo, Sandbox } from '@worldapptechnologies/nulu-e2b'

const VERSION_METADATA_KEY = 'nulu-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.nulu-${randomUUID()}.tmp`)
