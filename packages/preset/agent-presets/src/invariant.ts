/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-agent-presets`.
 * @module @worldapptechnologies/nulu-agent-presets/invariant
 */
...
// joins, and the `agent` field `nulu-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@worldapptechnologies/nulu-agent-presets'

const PACKAGE_NAME = '@worldapptechnologies/nulu-agent-presets'
