 ...
 * @module @worldapptechnologies/nulu-agent-presets/mount
 */
...
import type { EntryTree } from '@worldapptechnologies/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@worldapptechnologies/nulu-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@worldapptechnologies/nulu-*` row would fail to import. The
 ...
 * invariant companion's service listener, and `nulu-invariants` is a
