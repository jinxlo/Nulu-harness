 ...
 * @module @worldapptechnologies/nulu-agent-presets/discovery
 */
...
import { expandHomePath } from '@worldapptechnologies/nulu-home-paths'
 ...
 *
 * This package owns the writable root the way `nulu-skill-filesystem` owns
 * `<nuluHome>/skills`: where a person's own presets go is the same place in
