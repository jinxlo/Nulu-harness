 ...
 * @module @worldapptechnologies/nulu-agent-presets/composition-inventory
 */

import { readFile } from 'node:fs/promises'
import { load } from 'js-yaml'
import type { FiberState } from '@worldapptechnologies/cordis'
import { isJsExpr, type EntryTree } from '@worldapptechnologies/cordis-plugin-loader'
