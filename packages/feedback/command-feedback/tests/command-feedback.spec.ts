...
import SessionStore, { foldSurface, Session, SessionId } from '@worldapptechnologies/nulu-session'
...
vi.mock('@worldapptechnologies/nulu-anonymous-user-id', () => ({
...
describe('@worldapptechnologies/nulu-command-feedback registration', () => {
