...
Indirectly, through the consumer that records a canonical zone on a durable message, from which `nulu-time-context` renders the turn's model-visible zone instruction and timestamp.
