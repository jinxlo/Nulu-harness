 ...
 * evaluates `nulu-web-fetch-http` without a Node transport.
 * @module @worldapptechnologies/nulu-http-proxy/policy
 */
 ...
 *
 * This is the single answer both the installed dispatcher and `nulu-web-fetch-http` consult, so a URL
