 ...
 * @module @worldapptechnologies/nulu-launch-environment
 */
...
export const NULU_LAUNCH_ENVIRONMENT_KEY = 'launchEnvironment'
...
export function launchEnvironmentOf(ctx: Context): LaunchEnvironmentSnapshot {
  return ctx.get(NULU_LAUNCH_ENVIRONMENT_KEY)
