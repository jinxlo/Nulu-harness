...
import type { TerminalCloseFailure } from '@worldapptechnologies/nulu-api-terminal-controller/client'
import type { WebTerminalId } from '@worldapptechnologies/nulu-api-terminal-controller/types'
import type { HostObservable, InjectFace, PropsLocale, PropsRuntime } from '@worldapptechnologies/nulu-client-ui-slots'
