---
description: "Web ask_user_question feature for the nulu web client: the composer-takeover question UI and the plan-review approval card."
kind: "package-reference"
---

# @worldapptechnologies/nulu-client-ui-user-questions
...
Indirectly, through `nulu-tool-ask-user`, whose model-visible schema and answer rendering this package presents in the Web client.

#### KV Cache effect

No direct invalidation; `nulu-tool-ask-user` owns the model-visible tool call and result.
