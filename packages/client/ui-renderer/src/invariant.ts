/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-client-ui-renderer`.
 * @module @worldapptechnologies/nulu-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@worldapptechnologies/nulu-client-ui-slots'
import type { InvariantInstaller } from '@worldapptechnologies/nulu-invariants'

const PACKAGE_NAME = '@worldapptechnologies/nulu-client-ui-renderer'
