...
import type { GoalActivation, GoalSnapshot } from '@worldapptechnologies/nulu-goal/client'
import {
...
import type { InjectFace, PropsLocale, TranslateNS } from '@worldapptechnologies/nulu-client-ui-slots'
...
export type GoalDockProps =
  import('@worldapptechnologies/nulu-client-ui-slots').PropsRuntime<'conversation.input.dock'>
