...
import * as Cordis from '@worldapptechnologies/cordis'
import * as ClientStore from '@worldapptechnologies/nulu-client-store'
import * as UiSlots from '@worldapptechnologies/nulu-client-ui-slots'
import * as UiPrimitives from '@worldapptechnologies/nulu-client-ui-primitives'
import * as UiDockkit from '@worldapptechnologies/nulu-client-ui-dockkit'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@worldapptechnologies/cordis': Cordis,
    '@worldapptechnologies/nulu-client-store': ClientStore,
    '@worldapptechnologies/nulu-client-ui-slots': UiSlots,
    '@worldapptechnologies/nulu-client-ui-primitives': UiPrimitives,
    '@worldapptechnologies/nulu-client-ui-dockkit': UiDockkit,
