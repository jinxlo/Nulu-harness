 ...
 * (Nulu Chat's DragMask). Decoration only: `pointer-events: none` keeps
...
/** Tilted photo-and-note cards (Nulu Chat upload illustration). */
const UploadIllustration = () => (
  <svg width="115" height="84" viewBox="0 0 115 84" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#nuluDropOverlayClip)">
    ...
    <defs>
      <clipPath id="nuluDropOverlayClip">
...
/** Greyed cards with a blocked badge (Nulu Chat disabled illustration). */
