...
import type { NuluClientManifest } from '@worldapptechnologies/nulu-package-manifest'
 ...
 */
export function parseNuluClient(pkgName: string, value: unknown): NuluClientManifest | undefined {
  if (value === undefined) return undefined
