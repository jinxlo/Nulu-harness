...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@worldapptechnologies/nulu-client-ui-slots'
import { FileTypeIcon, IconRefreshOutline16, Menu, Tooltip, classifyFileType } from '@worldapptechnologies/nulu-client-ui-primitives'
import { pathPartsOf } from '@worldapptechnologies/nulu-util-workspace-path'
