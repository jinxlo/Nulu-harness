 ...
 *
 * The type claims every `nulu-resource://file/session/<sessionId>/<path>`
...
export const TEXTPREVIEW_ID = '@worldapptechnologies/nulu-client-ui-sidebar-documentpreview'
