/**
 * The address-to-read translation: a `nulu-resource://file/session/<id>/<path>`
...
describe('hostFileOf', () => {
  it('reads the session and the decoded relative path out of a session file address', () => {
    ...
    expect(hostFileOf('nulu-resource://file/session/s%2F1/work/a%20b%23c.md')).toEqual({ sessionId: 's/1', path: 'work/a b#c.md' })
  })
  ...
  it('throws for an address that is not a Session file address', () => {
    for (const address of [
      'nulu-resource://file/absolute/etc/hosts', 'nulu-resource://file/absolute/C:/w/a.md',
      'nulu-resource://file/shared/team/notes.md', 'nulu-resource://file/session', 'file:///work/notes.md', 'sidebar://guide',
    ]) {
