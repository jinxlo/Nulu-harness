/**
 * Package-owned invariant companion for `@worldapptechnologies/nulu-client-hmr`.
 * @module @worldapptechnologies/nulu-client-hmr/invariant
 */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-client-hmr'
