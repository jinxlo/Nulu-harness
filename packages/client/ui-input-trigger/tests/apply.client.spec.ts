...
import { apply, inject, InputTriggerService } from '@worldapptechnologies/nulu-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@worldapptechnologies/nulu-client-ui-input-trigger/client'
