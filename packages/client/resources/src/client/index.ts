...
import type { RootStandardSourceContribution } from '@worldapptechnologies/nulu-client-ui-slots'
...
export type { ResourceProtocolMap } from '@worldapptechnologies/nulu-client-ui-slots'
