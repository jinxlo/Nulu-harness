 ...
 * @module @worldapptechnologies/nulu-client-ui-message-feedback/client/dialog
 */
...
import type { FeedbackCategory, FeedbackRecord } from '@worldapptechnologies/nulu-command-feedback/types'
import type { MessageFeedbackRating } from '@worldapptechnologies/nulu-message-feedback/types'
