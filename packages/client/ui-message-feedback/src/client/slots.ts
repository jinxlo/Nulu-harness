 ...
 * @module @worldapptechnologies/nulu-client-ui-message-feedback/client/slots
 */
...
import type { MessageFeedbackItem, MessageFeedbackRating } from '@worldapptechnologies/nulu-message-feedback/types'
