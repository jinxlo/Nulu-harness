...
import type { FileUploadReceiptId } from '@worldapptechnologies/nulu-client-file-upload/client'
...
import type { SessionPendingInteraction } from '@worldapptechnologies/nulu-client-ui-session/client'
