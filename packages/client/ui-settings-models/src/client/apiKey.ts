 ...
 * @module @worldapptechnologies/nulu-client-ui-settings-models/apiKey
 */

/**
 * Twin of `normalizeApiKey` in `@worldapptechnologies/nulu-llm`: printable ASCII, space
 ...
 * `validateNuluModels` is kept in step with the host's `catalogModel`.
 */
