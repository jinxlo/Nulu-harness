...
export const en = {
  ...
  nuluChatBaseUrl: 'https://api.nulu.com',
  nuluMessagesBaseUrl: 'https://api.nulu.com/anthropic',
  nuluEndpointHint: 'Use an endpoint compatible with the configured connection.',
  models: 'Models',
  ...
  welcomeBody: "Nulu Harness 0.1 remains in testing for Harness developers. Many areas need further improvement, and we welcome feedback from the developer community. Nulu Harness's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the NULU plugin ecosystem.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  nuluChatBaseUrl: 'https://api.nulu.com',
  nuluMessagesBaseUrl: 'https://api.nulu.com/anthropic',
  nuluEndpointHint: '请填写与当前连接配置兼容的 API 地址。',
  models: '模型目录',
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Nulu Harness 目前的 0.1 版本仍处在面向 Harness 开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取广大开发者的反馈建议。预计 Nulu Harness 的核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球 Harness 开发者加入 NULU 插件生态。',
  welcomeContinue: '继续',
  welcomeError: '暂时无法保存确认状态，请重试。',
  onboardingTitle: '添加一个 API Key 开始使用',
  onboardingDescription: '配置模型服务商，即可开始使用。',
