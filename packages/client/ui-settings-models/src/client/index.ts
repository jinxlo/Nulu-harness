 ...
 * the Models page plus the ordered internal-testing and official-Nulu
...
import { NuluOnboardingDialog } from './NuluOnboardingDialog.tsx'
import type { NuluOnboardingInjected } from './NuluOnboardingDialog.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const nuluOnboardingInjected = (): NuluOnboardingInjected => ({
    controller,
  ...
  ctx.slots.inject('settings.onboarding', () => ctx.slots.register({
    ...
    id: 'worldapp-gateway',
    order: 0,
    inject: nuluOnboardingInjected,
  }, NuluOnboardingDialog))
}
