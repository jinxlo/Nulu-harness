...
import type { LlmDiscoveredModel } from '@worldapptechnologies/nulu-api-remotes/client'
import { Button, Modal } from '@worldapptechnologies/nulu-client-ui-primitives'
import { formatCapacity, parseCapacity } from './NuluModelsEditor.tsx'
 ...
 */
export type ModelDraft = NuluModelDraft
 ...
 * {@link formatCapacity}, shared with the Nulu catalog editor so both
