...
describe('tabs', () => {
  it('opens a tab into a pane and focuses it', () => {
    const { state, minter, paneId, guideTabId } = fixture()
    const tab = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/a.txt', 'a.txt')
  ...
  it('closes the active tab onto its previous neighbour', () => {
    const { state, minter, paneId, guideTabId } = fixture()
    const first = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/a.txt', 'a.txt')
    const second = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/b.txt', 'b.txt')
...
describe('operations refuse', () => {
  ...
  it('opening or inserting a tab into a floating pane', () => {
    ...
    const tab = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/b.txt', 'b.txt')
  ...
  it('putting a pane back with records that do not match the pane or the split', () => {
    ...
    const stray = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/c.txt', 'c.txt')
...
describe('replay', () => {
  it('rebuilds the same tree from the recorded operations', () => {
    const { state, minter, paneId, guideTabId } = fixture()
    const preview = fileTab(minter.next('tab'), 'nulu-resource://file/session/s/a.txt', 'a.txt')
