/**
 * The web-search card's staged form over the `web-search-gateway` settings
 * namespace.
 *
...
import type { SettingsScope, SettingsScopeSnapshot } from '@worldapptechnologies/nulu-client-ui-settings/client'
import {
...
/**
 * Namespace of the Nulu search provider. Spelled here rather than
 * imported: a client package must not depend on a Host package.
 */
export const WEB_SEARCH_NS = 'web-search-gateway'

/** Credential reference the provider resolves when the section names none. */
const DEFAULT_API_KEY_REF = 'WORLD_APP_TECHNOLOGIES_API_KEY'
...
/** Bridges the `web-search-gateway` scope and the credentials domain onto the card. */
export class WebSearchCardController {
  ...
  /**
   * @param scope - the bound settings scope for the `web-search-gateway` namespace.
