...
import { bindSnapshotSelector, SlotTestRuntime, stubSettingsScope } from '@worldapptechnologies/nulu-client-test-runtime'
...
import { EMPTY_CHAT_SNAPSHOT } from '@worldapptechnologies/nulu-client-ui-chat/client'
import type {
...
} from '@worldapptechnologies/nulu-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createConversationStore } from '@worldapptechnologies/nulu-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@worldapptechnologies/nulu-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@worldapptechnologies/nulu-client-locale/client'
import { apply, inject } from '@worldapptechnologies/nulu-client-ui-trajectory/client'
import { apply as nodeApply } from '@worldapptechnologies/nulu-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('nulu.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`nulu.trajectory.duration.${SID}`)).toBeNull()
  })
