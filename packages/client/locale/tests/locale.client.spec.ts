...
import { stubSettingsScope, type StubSettingsScope } from '@worldapptechnologies/nulu-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@worldapptechnologies/nulu-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@worldapptechnologies/nulu-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (nulu-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared NULU home agrees', () => {
