...
import type { AttachmentId, ImageAttachmentRef, ImageMediaType } from '@worldapptechnologies/nulu-attachment'
 ...
 *  Hand-written mirror of `ImageMediaType` from nulu-attachment — the wire
