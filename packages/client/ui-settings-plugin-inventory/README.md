---
description: "Scope-grouped read-only plugin inventory tab in Web Plugins settings for the nulu web client: agent-preset compositions first, the global plane behind a disclosure, search across both."
kind: "package-reference"
---

# @worldapptechnologies/nulu-client-ui-settings-plugin-inventory
