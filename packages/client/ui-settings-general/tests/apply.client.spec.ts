...
import type { SettingsNamespaceView } from '@worldapptechnologies/nulu-settings/types'
...
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@worldapptechnologies/nulu-client-locale/src/locale-settings.ts'
...
const SELF = '@worldapptechnologies/nulu-client-ui-settings-general'
