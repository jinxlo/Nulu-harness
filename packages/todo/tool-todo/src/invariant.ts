/** Package-owned durable todo-snapshot invariants. @module @worldapptechnologies/nulu-tool-todo/invariant */
...
const PACKAGE_NAME = '@worldapptechnologies/nulu-tool-todo'
