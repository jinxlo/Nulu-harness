/**
 * Loader export-shape guard for @worldapptechnologies/nulu-tool-lsp. It is a NAMESPACE plugin with `inject`, so a
...
describe('nulu-tool-lsp Loader export-shape guard', () => {
