...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`packages/web/web-search-gateway/src/provider.ts#DeepSeekSearchLlmRequest`](#persistence-type-packageswebweb-search-gatewaysrcprovidertsdeepseeksearchllmrequest) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
