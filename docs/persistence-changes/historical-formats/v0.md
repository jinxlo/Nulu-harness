...
Inspect the V0 persistence types captured at `nulu-v0.1.2-rc.1`. Assistant chunks are separate events, and the physical header stores an optional inherited-event count as `seedLength`. The complete schemas retain the declared types at this checkpoint, including a broad numeric header version.
...
The source is the published tag `nulu-v0.1.2-rc.1`, whose writer constant is 0. This is the last V0 tag in the [captured prerelease archive](../releases/README.md); the [tag record](../releases/nulu-v0.1.2-rc.1.md) preserves its release context. Earlier V0 tags have additional type differences and are not replaced by this snapshot.
...
roots:
  ...
  "event:session-log-gateway/delivery-accepted": 9c413656ca5600ea33812d43c4e7923a541cfb6ab8b5bc98e415f295f44e40da
  ...
  "event:web/nulu-search-llm-request": cf6e3aaf1e2de6480aa0157730a41b9a492108a55304100b0f7e112711dd4331
```
...
| `event:session-log-gateway/delivery-accepted` | event | `9c413656ca5600ea33812d43c4e7923a541cfb6ab8b5bc98e415f295f44e40da` | [`event:session-log-gateway/delivery-accepted`](#persistence-type-eventsession-log-gatewaydelivery-accepted) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:session-log-gateway/delivery-accepted[0].data`](#persistence-type-eventsession-log-gatewaydelivery-accepted0data) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"session-log-gateway/delivery-accepted"` |

<a id="persistence-type-eventsession-log-gatewaydelivery-accepted0data"></a>

#### `event:session-log-gateway/delivery-accepted[0].data`

SHA-256: `09c4e39433565d24c20ce90f64125f9bde4e8b9680652455f8cf058e47299c6f`

Sources: `packages/session/session-log-gateway/src/types.ts`
...
<a id="persistence-type-eventwebnulu-search-llm-request0databody"></a>

#### `event:web/nulu-search-llm-request[0].data.body`

SHA-256: `930a6567a10bb62ddd157bd8abdf4b182810c8c3b49d91309b3b009a5fed9731`

Sources: `packages/web/web-search-gateway/src/provider.ts`

| Property | Presence | Type |
|---|---|---|
| `max_tokens` | required | `number` |
| `messages` | required | [`event:web/nulu-search-llm-request[0].data.body.messages`](#persistence-type-eventwebnulu-search-llm-request0databodymessages) |
| `model` | required | `string` |
| `tools` | required | [`event:web/nulu-search-llm-request[0].data.body.tools`](#persistence-type-eventwebnulu-search-llm-request0databodytools) |

<a id="persistence-type-eventwebnulu-search-llm-request0databodymessages"></a>

#### `event:web/nulu-search-llm-request[0].data.body.messages`

SHA-256: `b993441f8ce7d27b80e619e113e232ae8e62d3d5a8340f6bfe12d8c4c018e62f`

| Position | Presence | Type |
|---|---|---|
| 0 | required | [`event:web/nulu-search-llm-request[0].data.body.messages[0]`](#persistence-type-eventwebnulu-search-llm-request0databodymessages0) |

<a id="persistence-type-eventwebnulu-search-llm-request0databodymessages0"></a>

#### `event:web/nulu-search-llm-request[0].data.body.messages[0]`
...
| Property | Presence | Type |
|---|---|---|
| `content` | required | [`event:web/nulu-search-llm-request[0].data.body.messages[0].content`](#persistence-type-eventwebnulu-search-llm-request0databodymessages0content) |
| `role` | required | `"user"` |

<a id="persistence-type-eventwebnulu-search-llm-request0databodymessages0content"></a>

#### `event:web/nulu-search-llm-request[0].data.body.messages[0].content`

SHA-256: `8f6d609794bf5afc01d7ccf3e03811d32f4b8047f58a2c9a98db0154c2ad7cb9`

| Position | Presence | Type |
|---|---|---|
| 0 | required | [`event:web/nulu-search-llm-request[0].data.body.messages[0].content[0]`](#persistence-type-eventwebnulu-search-llm-request0databodymessages0content0) |

<a id="persistence-type-eventwebnulu-search-llm-request0databodymessages0content0"></a>

#### `event:web/nulu-search-llm-request[0].data.body.messages[0].content[0]`

SHA-256: `4e887768586528565381dadbddee6cef555874148089f4579e0b4b1ad096fc9c`

Sources: `packages/llm/llm/src/types.ts` · `packages/web/web-search-gateway/src/provider.ts`
...
<a id="persistence-type-eventwebnulu-search-llm-request0databodytools"></a>

#### `event:web/nulu-search-llm-request[0].data.body.tools`

SHA-256: `4aed17ec726b5397c29f6cb4bcd7905dc1a12bb6140f1657f073cd24380f2af8`

| Position | Presence | Type |
|---|---|---|
| 0 | required | [`event:web/nulu-search-llm-request[0].data.body.tools[0]`](#persistence-type-eventwebnulu-search-llm-request0databodytools0) |

<a id="persistence-type-eventwebnulu-search-llm-request0databodytools0"></a>

#### `event:web/nulu-search-llm-request[0].data.body.tools[0]`
...
- [`event:web/nulu-search-llm-request[0].data.body.messages[0].content[0]`](#persistence-type-eventwebnulu-search-llm-request0databodymessages0content0)
...
| `body` | required | [`event:web/nulu-search-llm-request[0].data.body`](#persistence-type-eventwebnulu-search-llm-request0databody) |
