---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.0-rc.6."
kind: persistence-release
---

# Persistence release: nulu-v0.1.0-rc.6

English | [中文](nulu-v0.1.0-rc.6.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.0-rc.6` |
| Source date | 2026-08-13T11:56:40.000Z |
| Release record | Tag only; no release object. |
| Previous release | [nulu-v0.1.0-rc.5](nulu-v0.1.0-rc.5.md) |
...
| This snapshot | [nulu-v0.1.0-rc.6.schema.json](nulu-v0.1.0-rc.6.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.0-rc.6
previous: nulu-v0.1.0-rc.5
