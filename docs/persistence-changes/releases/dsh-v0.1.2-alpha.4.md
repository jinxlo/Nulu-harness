---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.2-alpha.4."
kind: persistence-release
---

# Persistence release: nulu-v0.1.2-alpha.4

English | [中文](nulu-v0.1.2-alpha.4.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.2-alpha.4` |
| Source date | 2026-09-01T15:37:26.000Z |
| Release record | Release object present. |
| Previous release | [nulu-v0.1.2-alpha.3](nulu-v0.1.2-alpha.3.md) |
...
| This snapshot | [nulu-v0.1.2-alpha.4.schema.json](nulu-v0.1.2-alpha.4.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.2-alpha.4
previous: nulu-v0.1.2-alpha.3
