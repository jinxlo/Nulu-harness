---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.5-alpha.1."
kind: persistence-release
---

# Persistence release: nulu-v0.1.5-alpha.1

English | [中文](nulu-v0.1.5-alpha.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.5-alpha.1` |
| Source date | 2026-09-08T15:25:45.000Z |
| Release record | Release object present. |
| Previous release | [nulu-v0.1.3-alpha.2](nulu-v0.1.3-alpha.2.md) |
...
| This snapshot | [nulu-v0.1.5-alpha.1.schema.json](nulu-v0.1.5-alpha.1.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.5-alpha.1
previous: nulu-v0.1.3-alpha.2
