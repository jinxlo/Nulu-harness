---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.2-alpha.5."
kind: persistence-release
---

# Persistence release: nulu-v0.1.2-alpha.5

English | [中文](nulu-v0.1.2-alpha.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.2-alpha.5` |
| Source date | 2026-09-02T07:57:43.000Z |
| Release record | Release object present. |
| Previous release | [nulu-v0.1.2-alpha.4](nulu-v0.1.2-alpha.4.md) |
...
| This snapshot | [nulu-v0.1.2-alpha.5.schema.json](nulu-v0.1.2-alpha.5.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.2-alpha.5
previous: nulu-v0.1.2-alpha.4
