---
description: "回溯 nulu-v0.1.5-rc.2 的已声明 Session 持久化类型及相邻版本变化。"
kind: persistence-release
---

# 持久化版本回溯: nulu-v0.1.5-rc.2

[English](nulu-v0.1.5-rc.2.md) | 中文
...
| 项目 | 记录值 |
|---|---|
| 源码 tag | `nulu-v0.1.5-rc.2` |
| 源码日期 | 2026-09-10T13:50:19.000Z |
| 发行记录 | 有 release 对象。 |
| 前一版本 | [nulu-v0.1.5-rc.1](nulu-v0.1.5-rc.1.zh.md) |
| Session 写入版本 | 3 |
| 完整重建清单 | <!-- persistence-release-inventory:start -->59 个根类型 / 462 种类型<!-- persistence-release-inventory:end --> |
| 本条快照 | [nulu-v0.1.5-rc.2.schema.json](nulu-v0.1.5-rc.2.schema.json) |
