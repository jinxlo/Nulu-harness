---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.0-rc.5."
kind: persistence-release
---

# Persistence release: nulu-v0.1.0-rc.5

English | [中文](nulu-v0.1.0-rc.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.0-rc.5` |
| Source date | 2026-08-13T11:38:46.000Z |
| Release record | Tag only; no release object. |
| Previous release | [nulu-v0.1.0-rc.3](nulu-v0.1.0-rc.3.md) |
...
| This snapshot | [nulu-v0.1.0-rc.5.schema.json](nulu-v0.1.0-rc.5.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.0-rc.5
previous: nulu-v0.1.0-rc.3
