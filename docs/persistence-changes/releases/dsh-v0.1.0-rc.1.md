---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.1.0-rc.1."
kind: persistence-release
---

# Persistence release: nulu-v0.1.0-rc.1

English | [中文](nulu-v0.1.0-rc.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.1.0-rc.1` |
| Source date | 2026-08-13T08:51:36.000Z |
| Release record | Tag only; no release object. |
| Previous release | [nulu-v0.0.1-rc.5](nulu-v0.0.1-rc.5.md) |
...
| This snapshot | [nulu-v0.1.0-rc.1.schema.json](nulu-v0.1.0-rc.1.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.1.0-rc.1
previous: nulu-v0.0.1-rc.5
