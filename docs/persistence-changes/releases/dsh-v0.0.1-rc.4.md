---
description: "Retrospective Session persistence types and adjacent-release changes for nulu-v0.0.1-rc.4."
kind: persistence-release
---

# Persistence release: nulu-v0.0.1-rc.4

English | [中文](nulu-v0.0.1-rc.4.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `nulu-v0.0.1-rc.4` |
| Source date | 2026-08-12T21:29:23.000Z |
| Release record | Tag only; no release object. |
| Previous release | [nulu-v0.0.1-rc.3](nulu-v0.0.1-rc.3.md) |
...
| This snapshot | [nulu-v0.0.1-rc.4.schema.json](nulu-v0.0.1-rc.4.schema.json) |
...
schemaVersion: 1
tag: nulu-v0.0.1-rc.4
previous: nulu-v0.0.1-rc.3
