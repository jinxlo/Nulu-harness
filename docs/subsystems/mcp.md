...
Protocol negotiation follows the SDK's supported revisions; there is no product setting that forces a protocol revision. The [configuration catalog](../config-catalog.md#worldapptechnologiesdsh-mcp-client) lists accepted client fields and defaults.
