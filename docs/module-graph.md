...
flowchart TD
  ...
  subgraph group_llm["packages/llm"]
    ...
    pkg_plugin_package_inventory_gateway["plugin-package-inventory"]
  ...
  pkg_session_log_gateway --> pkg_llm_api_extensions
  pkg_session_log_gateway --> pkg_invariants
  pkg_session_log_gateway --> pkg_session
  ...
  pkg_llm_gateway --> pkg_anonymous_user_id
  pkg_llm_gateway --> pkg_atomic_write
  pkg_llm_gateway --> pkg_attachment
  pkg_llm_gateway --> pkg_credentials
  pkg_llm_gateway --> pkg_llm_api_extensions
  pkg_llm_gateway --> pkg_fs
  pkg_llm_gateway --> pkg_home_paths
  pkg_llm_gateway --> pkg_launch_environment
  pkg_llm_gateway --> pkg_llm
  pkg_llm_gateway --> pkg_settings
  pkg_llm_gateway --> pkg_timeout
  ...
  pkg_web_search_gateway --> pkg_agent
  pkg_web_search_gateway --> pkg_credentials
  pkg_web_search_gateway --> pkg_launch_environment
  pkg_web_search_gateway --> pkg_session
  pkg_web_search_gateway --> pkg_settings
  pkg_web_search_gateway --> pkg_web
  ...
  pkg_plugin_package_inventory_gateway --> pkg_agent
  pkg_plugin_package_inventory_gateway --> pkg_agent_presets
  pkg_plugin_package_inventory_gateway --> pkg_llm_api_extensions
  pkg_plugin_package_inventory_gateway --> pkg_session
  ...
  pkg_sdk_jsonrpc_server --> pkg_llm_gateway
...
| [`session-log-gateway`](../packages/session/session-log-gateway) | `session` | [`llm-api-extensions`](../packages/llm/llm-api-extensions), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
...
| [`web-search-gateway`](../packages/web/web-search-gateway) | `web` | [`agent`](../packages/core/agent), [`credentials`](../packages/credentials/credentials), [`launch-environment`](../packages/util/launch-environment), [`session`](../packages/core/session), [`settings`](../packages/settings/settings), [`web`](../packages/web/web) |
...
| [`sdk-jsonrpc-server`](../packages/sdk/server) | `sdk` | [`agent`](../packages/core/agent), [`attachment`](../packages/attachment/attachment), [`llm`](../packages/llm/llm), [`llm-gateway`](../packages/llm/llm-gateway), [`scope`](../packages/core/scope), [`sdk-protocol`](../packages/sdk/protocol), [`session`](../packages/core/session), [`subagent`](../packages/subagent/subagent) |
