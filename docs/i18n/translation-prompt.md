...
- Source: `The committed agent workflow lives in .agents/skills/nulu-translate-docs`
- Bad: `进仓的 agent 工作流见 .agents/skills/nulu-translate-docs`
- Good: `仓库内置的 agent 工作流见 .agents/skills/nulu-translate-docs`
